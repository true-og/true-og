...
# Default: plugins/
# Special cases:
# ArenaRegen-OG -> plugins/Duels/extensions/
# Essentials-PAPI -> plugins/PlaceholderAPI/expansions/
# Statistics-PAPI -> plugins/PlaceholderAPI/expansions/
plugin_output_dir() {
    local plugin_name="$1"
    case "$plugin_name" in
        ...
        Player-PAPI) echo "$OUTPUT_DIR/PlaceholderAPI/expansions" ;;
